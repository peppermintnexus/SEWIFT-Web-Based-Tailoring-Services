            ...
            <div className='flex'>
                ...
                <div data-drawer-target="default-sidebar" data-drawer-toggle="default-sidebar" aria-controls="default-sidebar" type="button" class="inline-flex items-center justify-center w-20 h-auto px-2 py-5 my-2 ms-3 text-sm text-gray-500 rounded-lg sm:hidden bg-white dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
                    <ul className="space-y-3 items-center justify-center h-full">
                        ...
                        <li>
                            <a href="/AdminHomepage" className="hover:font-medium flex items-center mt-5 py-2 px-4 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        ...
                        <li>
                            <a href="/AdminJobOrder" className="hover:font-medium flex items-center py-2 px-4 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                        ...
                        <li>
                            <a href="/AdminSettings" className="hover:font-medium flex items-center py-2 px-4 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
                ...
                <div className="flex-1 w-full">
                    <div className="gap-5 p-4 container w-full h-full sm:h-screen]">
                        <div className='col-span-2 p-3 bg-[#Fefefe]'>
                            <h1 className='px-3 text-2xl font-medium'>Welcome to your Dashboard</h1>
                            <p className='px-3 text-[#7F7F7F]'>Recent reports and activities will be shown in this area</p>
    
                            <div className='mt-2 h-[75vh] sm:h-[83vh] bg-[#fefefe] overflow-y-auto'>
                                <div className="px-2 py-1 sm:py-3 space-y-4">
                                    <div className='relative inline-block grid grid-cols-2'>
                                        <div className='flex'>
                                    ...
                                    className="text-white bg-[#10aeb2] focus:bg-[#4096FF] hover:bg-[#4096FF] font-medium rounded-lg text-sm px-5 text-center inline-flex items-center" 
