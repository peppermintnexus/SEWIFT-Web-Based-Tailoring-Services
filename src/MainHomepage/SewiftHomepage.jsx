...
export default function SewiftHomepage() {
    return (
        <div className='min-h-screen'>
            ...
            <div className="min-h-screen bg-cover bg-center flex justify-center items-center pt-0 px-4 sm:px-16" style={{ backgroundImage: `url(${SewiftPicture})` }}>
                <div className='text-center'>
                    <h1 className='text-5xl sm:text-8xl font-semibold text-[#fefefe] mb-3'>Sewift Solutions</h1>
        ...
        <h1 className='text-center text-[#fefefe] text-3xl sm:text-5xl font-bold'>Features</h1>
        ...
        <h1 className='text-[#fefefe] text-3xl sm:text-4xl pt-10 px-5'>Client</h1>
        ...
        <h1 className='text-[#fefefe] text-3xl sm:text-4xl pt-10 px-5'>Tailor Shop</h1>
        <div className='grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 justify-items-center my-5 px-5 pt-12 gap-10 text-[#fefefe]'>
            <div className='grid justify-items-center'>
            ...
            <h1 className='text-[#171B1F] text-center font-semibold text-3xl sm:text-4xl'>Web Application</h1>
        <div className='grid justify-items-center my-5 pt-12 grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-10 text-[#171B1F]'>
            ...
            <div className="grid text-center justify-items-center">
                ...
                <p>Sewift keeps their clients updated of<br />their ordered apparels</p>
            </div>
        </div>
    </div>
        </div>
