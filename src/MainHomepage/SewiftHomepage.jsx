...
export default function SewiftHomepage() {
    return (
        <div className='min-h-screen'>
            ...
            <div className="min-h-screen bg-cover bg-center flex justify-center items-center pt-0 px-16" style={{ backgroundImage: `url(${SewiftPicture})` }}>
                <div className='text-center'>
                    <h1 className='text-8xl font-semibold text-[#fefefe] mb-3'>Sewift Solutions</h1>
                    <p className='text-xl text-[#fefefe] mb-7'>
                        SEWIFT is an online application that will provide swift<br />solutions for your tailoring needs.
                    </p>
                    <a href='/SignUp'>
                    <button className='font-semibold px-6 py-4 text-[#fefefe] text-xl bg-[#171B1F] hover:bg-[#40bec1] hover:text-[#fefefe] hover:shadow-xl'>
                        Try it now!
                    </button>
                    </a>
                </div>
            ...
            <div className='p-14 bg-[#171B1F]'>
                <h1 className='text-center text-[#fefefe] text-5xl font-bold'>Features</h1>
                <p className='text-center pt-2 text-[#fefefe]'>Explore what you can do with SEWIFT we like to provide our users with the best features</p>
                <h1 className='text-[#fefefe] text-4xl pt-10 px-5'>Client</h1>
                <div className='grid justify-items-center my-5 px-5 pt-12 grid-cols-5 gap-10 text-[#fefefe]'>
                    <div className='grid justify-items-center'>
                        <svg className='mb-2 w-9 h-9' viewBox="0 0 24 24" fill="#fefefe" xmlns="http://www.w3.org/2000/svg">
                        <g id="Interface / Shopping_Cart_02">
                        <path id="Vector" d="M3 3H3.26835C3.74213 3 3.97943 3 4.17267 3.08548C4.34304 3.16084 4.48871 3.28218 4.59375 3.43604C4.71269 3.61026 4.75564 3.8429 4.84137 4.30727L7.00004 16L17.4218 16C17.875 16 18.1023 16 18.29 15.9199C18.4559 15.8492 18.5989 15.7346 18.7051 15.5889C18.8252 15.4242 18.8761 15.2037 18.9777 14.7631L18.9785 14.76L20.5477 7.95996L20.5481 7.95854C20.7023 7.29016 20.7796 6.95515 20.6947 6.69238C20.6202 6.46182 20.4635 6.26634 20.2556 6.14192C20.0184 6 19.6758 6 18.9887 6H5.5M18 21C17.4477 21 17 20.5523 17 20C17 19.4477 17.4477 19 18 19C18.5523 19 19 19.4477 19 20C19 20.5523 18.5523 21 18 21ZM8 21C7.44772 21 7 20.5523 7 20C7 19.4477 7.44772 19 8 19C8.55228 19 9 19.4477 9 20C9 20.5523 8.55228 21 8 21Z" stroke="#fefefe" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" />
                        </g>
                        </svg>
                        <h1 className='pt-3 text-lg'>Instant Purchase</h1>
                    </div>
                    <div className='grid justify-items-center'>
                    <svg className='mb-2 w-9 h-9' fill="#fefefe" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
                    viewBox="0 0 472.615 472.615" xml:space="preserve"><g>
                        <g><path d="M357.916,38.637h-60.825c0.005,33.572-27.212,60.788-60.784,60.788c-33.573,0-60.789-27.216-60.748-60.788h-60.861
                        L0,153.336l63.137,63.137l51.551-51.545v269.049h243.24V164.929l51.549,51.545l63.138-63.137L357.916,38.637z"/></g>
                        </g>
                        </svg>
                        <h1 className='pt-3 text-lg'>Customized Order</h1>
                    </div>
                    <div className='grid justify-items-center'>
                    <svg className='mb-2 w-9 h-9' fill="#fefefe" viewBox="0 0 36 36" version="1.1"  preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    ...
                    <div className='grid justify-items-center'>
                    <svg className='mb-2 w-9 h-9' viewBox="0 0 20 20" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    <g id="Page-1" stroke="#fefefe" stroke-width="0" fill-rule="evenodd">
                        <g id="Dribbble-Light-Preview" transform="translate(-380.000000, -2199.000000)" fill="#fefefe">
                    ...
                    <div className='grid justify-items-center'>
                    <svg className='mb-2 w-9 h-9' viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                    <path fill="#fefefe" fill-rule="evenodd" d="M0,8 C0,6.34315 1.34315,5 3,5 L13,5 C14.6569,5 16,6.34315 16,8 C16,9.65685 14.6569,11 13,11 L3,11 C1.34315,11 0,9.65685 0,8 Z M10,7 L13,7 C13.5523,7 14,7.44772 14,8 C14,8.55228 13.5523,9 13,9 L8,9 L10,7 Z"/>
                    </svg>
                    <h1 className='pt-3 text-lg'>Track Order Progress</h1>
                    </div>
                </div>

                <h1 className='text-[#fefefe] text-4xl pt-10 px-5'>Tailor Shop</h1>
                <div className='grid justify-items-center my-5 px-5 pt-12 grid-cols-5 gap-10 text-[#fefefe]'>
                    <div className='grid justify-items-center'>
                    <svg className='mb-2 w-9 h-9' viewBox="0 0 24 24" id="_24x24_On_Light_Queue-In" data-name="24x24/On Light/Queue-In" xmlns="http://www.w3.org/2000/svg">
                    <rect id="view-box" width="24" height="24" fill="none"/>
                    <path id="Shape" d="M3.75,19.5A3.75,3.75,0,0,1,0,15.75V6.607A2.607,2.607,0,0,1,2.607,4H4V2.75A2.754,2.754,0,0,1,6.75,0h10A2.753,2.753,0,0,1,19.5,2.75v10a2.752,2.752,0,0,1-2.75,2.75H15.5v1.393A2.607,2.607,0,0,1,12.892,19.5ZM1.5,6.607V15.75A2.25,2.25,0,0,0,3.75,18h9.142A1.108,1.108,0,0,0,14,16.893V15.5H6.75A2.753,2.753,0,0,1,4,12.75V5.5H2.607A1.107,1.107,0,0,0,1.5,6.607Zm4-3.857v10A1.252,1.252,0,0,0,6.75,14h10A1.251,1.251,0,0,0,18,12.75v-10A1.251,1.251,0,0,0,16.75,1.5h-10A1.252,1.252,0,0,0,5.5,2.75ZM9.25,10.5a.75.75,0,1,1,0-1.5h5a.75.75,0,1,1,0,1.5Z" transform="translate(2.25 2.25)" fill="#fefefe"/>
                    <path id="Shape-2" data-name="Shape" d="M.75,1.5h5a.75.75,0,0,0,0-1.5h-5a.75.75,0,0,0,0,1.5Z" transform="translate(17.25 8.75) rotate(-180)" fill="#fefefe"/>
                    </svg>
                    <h1 className='pt-3 text-lg'>Job Order Queue</h1>
                    </div>
                    <div className='grid justify-items-center'>
                    <svg className='mb-2 w-9 h-9' fill="#fefefe" version="1.1" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" xmlns:xlink="http://www.w3.org/1999/xlink" enable-background="new 0 0 512 512">
                    <g>
                        <g>
                            <g>
                    ...
                    <div className='grid justify-items-center'>
                    <svg className='mb-2 w-9 h-9' viewBox="0 0 24 24" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    <g id="Page-1" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                        <g id="Shop">
                            <rect id="Rectangle" fill-rule="nonzero" x="0" y="0" width="24" height="24">
                            </rect>
                            <path d="M4,12 L4,19 C4,20.1046 4.89543,21 6,21 L18,21 C19.1046,21 20,20.1046 20,19 L20,12" id="Path" stroke="#fefefe" stroke-width="2" stroke-linecap="round"></path>
                            <path d="M9,8 L15,8 L15,9 C15,10.6569 13.6569,12 12,12 L12,12 C10.3431,12 9,10.6569 9,9 L9,8 Z" id="Path" stroke="#fefefe" stroke-width="2" stroke-linecap="round"></path>
                            <path d="M15,8 L20.5556,8 C20.801,8 21,8.19898 21,8.44444 L21,9 C21,10.6569 19.6569,12 18,12 L18,12 C16.3431,12 15,10.6569 15,9 L15,8 Z" id="Path" stroke="#fefefe" stroke-width="2" stroke-linecap="round"></path>
                            <path d="M3,8.44444 C3,8.19898 3.19898,8 3.44444,8 L9,8 L9,9 C9,10.6569 7.65685,12 6,12 L6,12 C4.34315,12 3,10.6569 3,9 L3,8.44444 Z" id="Path" stroke="#fefefe" stroke-width="2" stroke-linecap="round"></path>
                            <path d="M3.82594,3.41142 C3.86881,3.17328 4.07606,3 4.31804,3 L19.682,3 C19.9239,3 20.1312,3.17328 20.1741,3.41142 L20.8941,7.41142 C20.9493,7.71809 20.7136,8 20.402,8 L3.59804,8 C3.28644,8 3.05074,7.71809 3.10594,7.41142 L3.82594,3.41142 Z" id="Path" stroke="#fefefe" stroke-width="2" stroke-linecap="round"></path>
                            <path d="M9,16 C9,15.4477 9.44772,15 10,15 L14,15 C14.5523,15 15,15.4477 15,16 L15,21 L9,21 L9,16 Z" id="Path" stroke="#fefefe" stroke-width="2" stroke-linecap="round"></path>
                        </g>
                    </g>
                    </svg>
                    ...
                    <div className='grid justify-items-center'>
                    <svg className='mb-2 w-9 h-9' fill="#fefefe" viewBox="0 0 32 32" version="1.1" xmlns="http://www.w3.org/2000/svg">
            ...
            <div className='bg-[#f7f7f7] py-16'>
                    ...
                    <div className='grid justify-items-center my-5 pt-12 grid-cols-3 gap-10 text-[#171B1F]'>
                        ...
                        <path d="M9.15316 5.40838C10.4198 3.13613 11.0531 2 12 2C12.9469 2 13.5802 3.13612 14.8468 5.40837L15.1745 5.99623C15.5345 6.64193 15.7144 6.96479 15.9951 7.17781C16.2757 7.39083 16.6251 7.4699 17.3241 7.62805L17.9605 7.77203C20.4201 8.32856 21.65 8.60682 21.9426 9.54773C22.2352 10.4886 21.3968 11.4691 19.7199 13.4299L19.2861 13.9372C18.8096 14.4944 18.5713 14.773 18.4641 15.1177C18.357 15.4624 18.393 15.8341 18.465 16.5776L18.5306 17.2544C18.7841 19.8706 18.9109 21.1787 18.1449 21.7602C17.3788 22.3417 16.2273 21.8115 13.9243 20.7512L13.3285 20.4768C12.6741 20.1755 12.3469 20.0248 12 20.0248C11.6531 20.0248 11.3259 20.1755 10.6715 20.4768L10.0757 20.7512C7.77268 21.8115 6.62118 22.3417 5.85515 21.7602C5.08912 21.1787 5.21588 19.8706 5.4694 17.2544L5.53498 16.5776C5.60703 15.8341 5.64305 15.4624 5.53586 15.1177C5.42868 14.773 5.19043 14.4944 4.71392 13.9372L4.2801 13.4299C2.60325 11.4691 1.76482 10.4886 2.05742 9.54773C2.35002 8.60682 3.57986 8.32856 6.03954 7.77203L6.67589 7.62805C7.37485 7.4699 7.72433 7.39083 8.00494 7.17781C8.28555 6.96479 8.46553 6.64194 8.82547 5.99623L9.15316 5.40838Z" stroke="#1C274C" stroke-width="1.5"/>
                            ...
                            <p>Love the quality and service?<br />Give tailor shops a five-star rating</p>
                        </div>
                        <div class="grid text-center justify-items-center">
                        <svg className='mb-2 w-9 h-9' viewBox="0 0 16 16" xmlns="http://www.w3.org/2000/svg">
                        <path fill="#171B1F" fill-rule="evenodd" d="M0,8 C0,6.34315 1.34315,5 3,5 L13,5 C14.6569,5 16,6.34315 16,8 C16,9.65685 14.6569,11 13,11 L3,11 C1.34315,11 0,9.65685 0,8 Z M10,7 L13,7 C13.5523,7 14,7.44772 14,8 C14,8.55228 13.5523,9 13,9 L8,9 L10,7 Z"/>
                        </svg>
                            <h1 className='font-semibold pt-3 text-lg'>Check Progress</h1>
                            <p>Sewift keep their clients updated of<br />their ordered apparels</p>
                        </div>
                    </div>
                </div>
        </div>
