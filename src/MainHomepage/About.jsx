    ...
    return (
        <div className='min-h-screen bg-cover bg-center' style={{ backgroundImage: `url(${BackgroundOne})` }}>
            ...
            <div className='pt-20 bg-gradient-to-b from--500 text-[#fefefe] mx-4 sm:mx-32 my-12 rounded-xl px-4 sm:px-7 py-10 text-center'>
                ...
                <p className='text-lg sm:text-xl px-4 sm:px-20'>SEWIFT aims to transform tailoring experience. Our platform simplifies order management, enhances customer satisfaction, and empowers tailor shop employees with efficient tools. We are here to make tailoring seamless for everyone.</p>
            </div>
        </div>
    )
}
