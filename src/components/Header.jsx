  ...
  return (
    <div className='flex justify-between items-center h-20 max-w-screen-xl px-4 sm:px-10 mx-auto bg-[#171B1F] text-[#fefefe]'>
      ...
      <nav className='text-sm sm:text-normal md:text-lg flex font-semibold'>
        <a href='/' className='p-4 sm:p-6 hover:text-[#6793a8]'>
          Home
        </a>
        <a href='/About' className='p-4 sm:p-6 hover:text-[#6793a8]'>
          About
        </a>
        <a
          href='/TermsAndConditions'
          className='p-4 sm:p-6 hover:text-[#6793a8]'
        >
          Terms and Conditions
        </a>
        <a href='/Contact' className='p-4 sm:p-6 hover:text-[#6793a8]'>
          Contact
        </a>
        <a href='/MainLogin' className='p-4 sm:p-6 hover:text-[#6793a8]'>
          Login
        </a>
      </nav>
    </div>
