                ...
                <div className="pt-4 h-full px-6 overflow-y-auto bg-[#fefefe] dark:bg-gray-800">
                  ...
                  <ul className="space-y-2">
                     ...
                     <li>
                        ...
                        <svg fill="currentColor" className='w-5 h-5 text-[#2b3a47] transition duration-75 dark:text-gray-400 group-hover:text-[#2b3a47] dark:group-hover:text-white' version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
                        viewBox="0 0 512.001 512.001" xml:space="preserve">
                           ...
                           <span className="ms-3 text-black group-hover:text-[#2b3a47]">Employees</span>
                        </a>
                     </li>
                     <li>
                     ...
                     <li>
                        <a href="/AdminSettings" className="hover:font-medium flex items-center mt-28 p-2 px-4 text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700 group">
