...
export default function AdminHeader() {
    ...
    <div className='flex justify-between items-center'>
        <a href="/AdminHomepage" className='flex-shrink-0'>
            <img src={LogoBlack} className="ml-4 sm:ml-14 mt-5 h-10" alt="Sewift Logo" />
        </a>
        ...
        <div className='mt-5 flex items-center flex-shrink-0'>
            ...
            <h1 className='pl-2 text-[#7F7F7F] text-sm'>Name sa Admin</h1>
        </div>
    </div>
</div>
    )
